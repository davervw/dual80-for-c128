...
THe regular 40-column screen (VIC-II) is on the right, and normally 80-column screen (VDC) is on the left, but reconfigured to 40 columns and IRQ copies what KERNAL stores there to the VIC-II screen
